...
<section id="blog" class="bg-light py-5">
    <div class="container text-center">
        <h3 class="text-primary">Video Posts</h3>
        <div class="row mt-4">
            <?php 
            include 'db.php'; // Your database connection

            // Fetch uploaded videos
            $query = "SELECT * FROM videos ORDER BY created_date DESC"; 
            ...
            <div class="col-md-4 mt-4 fade-in <?= $blog_class ?>">
                <div class="card shadow hover-zoom">
                    <div class="card-body">
                        <video class="card-img-top" controls preload="metadata" style="height: 250px; object-fit: cover;">
                            <source src="uploads/videos/<?php echo htmlspecialchars($row['video_path']); ?>" type="video/mp4">


                            Your browser does not support the video tag.
                        </video>
                        <h4 class="card-title"><?= htmlspecialchars($row['title']) ?></h4>
                        <small class="text-muted"><?= htmlspecialchars($row['created_date']) ?></small>
                    </div>
                </div>
            </div>
            <?php 
